...
if __name__ == "__main__":
    ...
    print(u'**********读取Theano Mnist数据集的压缩文件**********')
    t = time()
    mnistSet = loadTheanoMnistSet()
    print("Total time:", time() - t)
    train_X, train_Y, valid_X, valid_Y, test_X, test_Y = mnistSet[0], mnistSet[1], mnistSet[2], mnistSet[3], mnistSet[
        4], mnistSet[5]
    print('train_X:', np.shape(train_X), 'train_Y:', np.shape(train_Y))
