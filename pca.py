...
if __name__ == "__main__":
    ...
    pca.fit(train_X)
    print
    '各维度的方差: ', pca.explained_variance_
    print
    '各维度的方差值占总方差值的比例: ', pca.explained_variance_ratio_, '\n'
    ...
    '各维度的方差值占总方差值的比例: ', pca.explained_variance_ratio_
    print
    '占总方差值90%的维度数量: ', pca.n_components_, '\n'
    ...
    print
    '各维度的方差: ', ipca.explained_variance_
    print
    '各维度的方差值占总方差值的比例: ', ipca.explained_variance_ratio_
